...
<script src="<?php base_url();?>/CodeIgniter_2.1.3/js/vendor/jquery.ui.widget.js"></script>
...
<script src="<?php base_url();?>/CodeIgniter_2.1.3/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="<?php base_url();?>/CodeIgniter_2.1.3/js/jquery.fileupload.js"></script>
<!-- The File Upload file processing plugin -->
<script src="<?php base_url();?>/CodeIgniter_2.1.3/js/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<script src="<?php base_url();?>/CodeIgniter_2.1.3/js/jquery.fileupload-ui.js"></script>
<!-- The main application script -->
<script src="<?php base_url();?>/CodeIgniter_2.1.3/js/main.js"></script>
