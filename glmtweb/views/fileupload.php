...
<!-- Generic page styles -->
<link rel="stylesheet" href="<?php base_url();?>/GLMT/css/style.css">
...
<link rel="stylesheet" href="<?php base_url();?>/GLMT/css/jquery.fileupload-ui.css">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript><link rel="stylesheet" href="<?php base_url();?>/GLMT/css/jquery.fileupload-ui-noscript.css"></noscript>
...
<script src="<?php base_url();?>/GLMT/js/vendor/jquery.ui.widget.js"></script>
...
<script src="<?php base_url();?>/GLMT/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="<?php base_url();?>/GLMT/js/jquery.fileupload.js"></script>
<!-- The File Upload file processing plugin -->
<script src="<?php base_url();?>/GLMT/js/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<script src="<?php base_url();?>/GLMT/js/jquery.fileupload-ui.js"></script>
<!-- The main application script -->
<script src="<?php base_url();?>/GLMT/js/main.js"></script>
